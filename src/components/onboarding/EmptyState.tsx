  ...
  return (
    <div className="flex flex-col items-center gap-3 px-4 py-8 text-center rounded-xl border border-dashed border-border/80 bg-muted/10 my-2">
      ...
      <div className="space-y-1">
        <h4 className="text-xs font-bold text-foreground">Media Library is Empty</h4>
        <p className="text-muted-foreground text-[11px] leading-relaxed max-w-[210px] mx-auto">
          Drag & drop MP4, MOV, MP3, WAV, PNG, or GLB files here, or click to browse.
        </p>
      </div>
      <Button
        size="sm"
