  ...
  return (
    <header className="relative z-30 flex h-11 w-full shrink-0 items-center justify-between border-b border-border/80 bg-background/80 px-2 sm:px-3 backdrop-blur-xl select-none overflow-x-auto no-scrollbar">
      ...
      <div className="flex shrink-0 items-center gap-0.5 sm:gap-1 md:gap-1.5 ml-1 sm:ml-2">
        ...
        {/* Toggle Right Panel (Middle Tools & Clip Inspector) */}
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="ghost"
              ...
              className={cn(
                ...
                inspectorOpen && 'bg-violet-500/15 text-violet-600 dark:text-violet-400 font-bold shadow-xs',
              )}
              onClick={handleToggleInspector}
              aria-label="Toggle Inspector of Middle Tools and Clips"
            >
              <PanelRight className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent className="text-[11px]">Toggle Middle Tools & Inspector</TooltipContent>
        </Tooltip>
